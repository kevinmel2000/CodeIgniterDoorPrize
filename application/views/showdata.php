...
<body style="background-image: url('<?php echo config_item('base_url') ?>back.jpg');background-repeat: no-repeat;background-attachment: fixed;background-size: cover;" >


<center><img src="<?php echo config_item('base_url') ?>/menuutama.jpg" height="450px"/></center>
<center><h1>UNDIAN</h1></center>

<center><img src="<?php echo config_item('base_url') ?>/assets/a.gif" height="80" width="700"/></center> 
                              
 <center>
	<a a href="<?php echo site_url().'Input/showdata' ?>" class="btn btn-sm btn-primary">Undi </a>  &nbsp&nbsp
